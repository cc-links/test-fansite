...
function MediaHistoryItem(props: IProps) {
  ...
  return (
    ...
    >
      {isAudio ? (
        <div className="absolute w-[100%] h-[100%] flex items-center justify-center text-(--grayscale-black-03)">
          <Icon icon="x:AudioWaveStyleStroke" fontSize={24} color="currentColor" />
        </div>
      ) : (
        <RetryImg
