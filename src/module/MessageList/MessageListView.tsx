...
import Typing from './MessageItem/Typing'
...
function MessageListView(props: IProps) {
  ...
  const { data, hasMore, reloading, isError, isEmpty, isLoadMoreError, isConfinedLoadMore, loading } =
    useMessageListStore()
  ...
  return (
    ...
    >
      ...
      <InfiniteList<string>
        ...
        style={{ height: 'auto' }}
        topContent={!loading && !reloading && <Typing accountId={userId} contactId={toUserId} />}
      />
      {/* typing... */}
