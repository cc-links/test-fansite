...
import TermsAndConditionsDrawer from '@/module/LoginRegister/RegisterLoginCommon/TermsAndConditionsDrawer'
import PrivacyPolicyDrawer from '@/module/LoginRegister/RegisterLoginCommon/PrivacyPolicyDrawer'
import EmailVerificationCodeDrawer from '@/components/EmailVerificationCodeDrawer'
import ForgotPassword from '@/module/LoginRegister/ForgotPassword'
  ...
  const { googleLoginBtnLoading, googleLogin } = useGoogleAuthLogin({
    ...
    onSuccess: async (data) => {
      ...
      try {
        ...
        // 登录成功
        ON_APP_EVENT_LOGIN_SUCCESS(res)
        onSucess?.(res)
      } catch (error: any) {
