...
import ConfitmDeleteAccount from '@/views/more/Setting/DeleteAccount/ConfirmDeleteAccount'
import DeleteEmailVerificationCodeDrawer from '@/views/more/Setting/DeleteAccount/DeleteEmailVerificationCodeDrawer'
