...
import ChangePassword from '@/views/more/Setting/Account/ChangePassword'
import ChangeEmail from '@/views/more/Setting/Account/ChangeEmail'
import ThirdPartyAccounts from '@/views/more/Setting/Account/ThirdPartyAccounts'
